package com.mxingo.passenger.module.base.log;
...
public class LogUtils {
    ...
    public static void d(String tagStr, String content) {
        ...
        if (customLogger != null) {
            customLogger.d(tag + "," + tagStr, content);
        } else {
            Log.d(tag + "," + tagStr, content);
        }
    }

    public static void d(String tagStr, String content, Throwable tr) {
        if (!allowD)
            return;
        StackTraceElement caller = getCallerStackTraceElement();
        String tag = generateTag(caller);
        ...
        if (customLogger != null) {
            customLogger.d(tag + "," + tagStr, content, tr);
        } else {
            Log.d(tag + "," + tagStr, content, tr);
        }
    }
    ...
    public static void e(String tagStr, String content) {
        ...
        if (customLogger != null) {
            customLogger.e(tag + "," + tagStr, content);
        } else {
            Log.e(tag + "," + tagStr, content);
        }
        if (isSaveLog) {
            point(PATH_LOG_INFO, tag + "," + tagStr, content);
        }
    }
    ...
    public static void e(String tagStr, String content, Throwable tr) {
        ...
        if (customLogger != null) {
            customLogger.e(tag + "," + tagStr, content, tr);
        } else {
            Log.e(tag + "," + tagStr, content, tr);
        }
        if (isSaveLog) {
    ...
    public static void i(String tagStr, String content) {
        ...
        if (customLogger != null) {
            customLogger.i(tag + "," + tagStr, content);
        } else {
            Log.i(tag + "," + tagStr, content);
        }
    ...
    public static void i(String tagStr, String content, Throwable tr) {
        ...
        if (customLogger != null) {
            customLogger.i(tag + "," + tagStr, content, tr);
        } else {
            Log.i(tag + "," + tagStr, content, tr);
        }
    ...
    public static void v(String tagStr, String content, Throwable tr) {
        ...
        if (customLogger != null) {
            customLogger.v(tag + "," + tagStr, content, tr);
        } else {
            Log.v(tag + "," + tagStr, content, tr);
        }
    }
    ...
    public static void w(String tagStr, String content) {
        ...
        if (customLogger != null) {
            customLogger.w(tag + "," + tagStr, content);
        } else {
            Log.w(tag + "," + tagStr, content);
        }
    }
    ...
    public static void w(String tagStr, String content, Throwable tr) {
        ...
        if (customLogger != null) {
            customLogger.w(tag + "," + tagStr, content, tr);
        } else {
            Log.w(tag + "," + tagStr, content, tr);
        }
    }
